...
//
//class MainActivityKotlin : AppCompatActivity(), CameraBridgeViewBase.CvCameraViewListener2 {
//
//    private var TAG = "MainActivityOpenCV"
//    private var MODEL_PATH = "mobile_face_net.tflite"
//
...
//        javaCameraView.setCvCameraViewListener(this@MainActivityKotlin)
//
//        btn_register.setOnClickListener {
//            if (mBitmap!=null) showDialog()
//            else Toast.makeText(this@MainActivityKotlin, "No face detected", Toast.LENGTH_SHORT).show()
//        }
//    }
//
...
//        onPause()
//
//        val dialog = Dialog(this@MainActivityKotlin)
...
//    }
//
//    private var baseLoaderCallback = object : BaseLoaderCallback(this@MainActivityKotlin) {
